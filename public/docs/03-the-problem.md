...
A store wants to know what you need. The only machinery that currently answers that question works
by accumulating you: cookies, history, lookalikes, a profile that gets more valuable to the platform
the more of you it holds. It infers intent it could simply have been told, and it optimises for the
