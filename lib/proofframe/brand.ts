...
export const BRAND = {
  ...
  sub: 'A two-sided, agent-native E-commerce loop: shoppers share demand without an identifier, merchants see the gap, and every promotion traces back to human-locked facts.',
