...
The badge in each page's header tells you the state: "7 WebMCP tools live" on the closet, "10 WebMCP tools live" on the studio, "preview mode" when the page is running as a plain editor.
