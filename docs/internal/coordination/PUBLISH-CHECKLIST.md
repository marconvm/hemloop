...
Decisions Marco still owns: whether `docs/internal/coordination/*` stays in the public history at all (it is
...
2. `docs/internal/coordination/*`: hide it if cheap; a history rewrite is not cheap, so it moves into
